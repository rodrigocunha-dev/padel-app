...
- **Evoluir a agenda do clube** (o fundador quer melhorá-la mais adiante; a v0 já tem dia/semana/mês, reserva de balcão e dias clicáveis). Ideias naturais: editar reserva sem cancelar/recriar, bloqueios recorrentes/mensalistas, arrastar para remarcar, filtro por esporte/quadra.
